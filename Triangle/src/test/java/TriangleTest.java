 ...
 */
    ...
    void givenCorrectSquareResultWhenRunTriangleSquareGeroneMethod() throws TriangleException {
        double result = Triangle.TriangleSquareGerone(2,3,4);
    ...
    void givenCorrectResultSquareWhenRunTriangleSquareGeroneMethod(int a, int b, int c, double result) throws TriangleException {
        assertEquals(result, Triangle.TriangleSquareGerone(a,b,c), 0.000001);
    }
    ...
    void givenCorrectSquareResultWhenRunTriangleSquareGeroneMetodWhenSquareIsNull() throws TriangleException {
        double result = Triangle.TriangleSquareGerone(1,2,3);
    ...
    void exceptionWhenRunTriangleSquareGeroneMetodWhenIncorrectPositiveSides(){
        assertThrows(TriangleException.class, () -> Triangle.TriangleSquareGerone(10,2,2));
    }
    ...
    void exceptionWhenRunTriangleSquareGeroneMetodWhenNegativeAndNullSides(){
        assertAll(
                ...
                () -> assertThrows(TriangleException.class, () -> Triangle.TriangleSquareGerone(10,-2,2)),
                () -> assertThrows(TriangleException.class, () -> Triangle.TriangleSquareGerone(10,2,-2)),
                () -> assertThrows(TriangleException.class, () -> Triangle.TriangleSquareGerone(0,2,2)),
                () -> assertThrows(TriangleException.class, () -> Triangle.TriangleSquareGerone(10,0,2)),
                () -> assertThrows(TriangleException.class, () -> Triangle.TriangleSquareGerone(10,2,0))
        );
    }
    ...
    void AssertJTest () {
        assertAll(
                () -> assertThat(Triangle.TriangleSquareGerone(10,5,10)).isEqualTo(24.206145913796355),
                () -> assertThat(Triangle.TriangleSquareGerone(10,5,10)).isGreaterThan(24).isLessThan(25)
        );
    }
